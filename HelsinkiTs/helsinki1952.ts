...
function ObjektumFeltolto(feltoltendoElem: string[]): Helsinki[] {
    ...
    for (var i = 0; i < feltoltendoElem.length; i++) {
        var daraboltAdatok: string[] = feltoltendoElem[i].split(" ");
        var eredmenyek: Helsinki = {
...
var helsinkiAdatok: Helsinki[] = ObjektumFeltolto(helsinki);
console.log(helsinkiAdatok);



function PontszerzoHelyezesek(vizsgaltTomb: Helsinki[]): number {
...
function ErmekSzama(vizsgaltTomb: Helsinki[]): [number, number, number] {
    var ermek: [number, number, number] = [0, 0, 0];
...
function ErmekSzamaKiir(ermekSzama: [number, number, number]): void {
...
function OlimpiaiPontok(vizsgaltTomb: Helsinki[]): number {
...
function OlimpiaiPontokKiir(eredmeny: number): void {
...
function UszasTorna(vizsgaltTomb: Helsinki[]): string {
    var Felirat: string = "";
    var UszasErmek: number = 0;
    var TornaErmek: number = 0;
...
function UszasTornaKiir(eredmeny: string): void {
...
function Kajakkenu(vizsgaltSzoveg: string): string {
